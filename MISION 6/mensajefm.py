...
class mensajefm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "mensajefm")
        ...
        self.uhd_usrp_sink_0.set_samp_rate((samp_rate*5))
        self.uhd_usrp_sink_0.set_time_now(uhd.time_spec(time.time()), uhd.ALL_MBOARDS)

        self.uhd_usrp_sink_0.set_center_freq(98e6, 0)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/estudiante/Documentos/comue1b/emisora (online-audio-converter.com).wav', True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 19000, 0.05, 0, 0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_add_xx_0_0_0, 1))
        self.connect((self.blocks_add_xx_0_0, 0), (self.blocks_add_xx_0_0_0, 2))
        self.connect((self.blocks_add_xx_0_0, 0), (self.qtgui_freq_sink_x_0, 2))
        self.connect((self.blocks_add_xx_0_0, 0), (self.qtgui_time_sink_x_0, 2))
        self.connect((self.blocks_add_xx_0_0_0, 0), (self.analog_wfm_tx_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_add_xx_0_0_0, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_add_xx_0_0, 2))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(100, self.samp_rate, 36E3, 40E3, 2E3, window.WIN_HAMMING, 6.76))
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(0.5, self.samp_rate, 15e3, 1e3, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(0.5, self.samp_rate, 15e3, 1e3, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, (self.samp_rate*5), 100e3, 15e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_sink_0.set_samp_rate((self.samp_rate*5))
...
def main(top_block_cls=mensajefm, options=None):
