...
class Mision2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Mision2")
        ...
        self._fc_range = qtgui.Range(50, 2200, 0.5, 50, 200)
        ...
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "Ganancia TX [dB]", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GTX_win)
        self._A_range = qtgui.Range(0, 1, 0.01, 0.5, 200)
        ...
        self.connect((self.analog_const_source_x_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
...
def main(top_block_cls=Mision2, options=None):
