...
class PRACTICA1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._FC_range = qtgui.Range(50, 2200, 1, 50, 200)
        self._FC_win = qtgui.RangeWidget(self._FC_range, self.set_FC, "FRECUNCIA MHZ", "counter_slider", float, QtCore.Qt.Horizontal)
